...
export class Animation extends Component {
	...
	updateTargetDistanceY(): void {
		const endPoint: number = window.innerHeight / 3
		...
		this.frameII = window.requestAnimationFrame(this.updateTargetDistanceY.bind(this))
	}
	...
	updateCurrentDistanceY(): void {
		...
		this.frame = window.requestAnimationFrame(this.updateCurrentDistanceY.bind(this))
	}
